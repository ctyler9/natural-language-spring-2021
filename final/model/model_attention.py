...
class AttentionModel(nn.Module):
	def __init__(self, vocab_size, DIM_EMB=300, HID_DIM=250,
				NUM_CLASSES=2, CONT_DIM=150, dropout=0.5, pad_idx=0):
		...
		self.lstm = nn.GRU(DIM_EMB, HID_DIM, 2, bidirectional=True,
	...
	def forward(self, x, seq_lens=None):
		...
		enc_packed, h_n = self.lstm(packed_embeds)
